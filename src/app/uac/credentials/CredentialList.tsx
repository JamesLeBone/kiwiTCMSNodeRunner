...
export default function CredentialList({list} : params) {
    const header = <IconButton href={newUrl} className="button fa fa-plus" title="Add New Credential" />
    
    return <ComponentSection header="Credentials" headerActions={header}>
        <table>
            <thead>
                <tr>
                    <th>Description</th>
