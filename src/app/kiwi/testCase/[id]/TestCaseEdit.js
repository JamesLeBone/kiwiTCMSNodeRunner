...
import TestPlanList from './TestPlanList.js'
import CaseScript from './CaseScript.js';
import ChildrenScripts from './ChildrenScripts.js';
import { RelatedComponents } from '@/components/kiwi/Component';
import Link from 'next/link'
import Execution from './Execution.js'

import { TagList } from '@/components/kiwi/Tags.js'
import * as TestCaseLib from '@/components/kiwi/TestCase.js'
import KiwiComments from '@/components/kiwi/KiwiComments.js'
...
// const kiwiUrl = id => 'http://kiwi01.me1.sil0.net/case/'+id
const kiwiUrl = id => 'http://kiwi.ftg.sil0.net/case/'+id
/**
...
export default function TestCaseEdit({testCase,attachments,plans,children,comments,components,tags,executions}) {
    ...
    const formatSummary = () => {
        ...
        const newSummary = TestCaseLib.TestCase.formatSummary(summary[0], securityGroupId)
        
        summary[1](newSummary)
        updateKiwiWith({summary: newSummary})
    }
    const setSecurity = v => {securityGroup[1](v), formatSummary()}
        ...
        { tceStatus.message }
            <ComponentSection header="Test Case Edit" className={styles.SpanAll}>
                ...
                <ActionBar>
                    ...
                    <ActionButton action={formatSummary} text="Format Summary" />
